...
FLAGS = flags.FLAGS
flags.DEFINE_enum('robot_type', 'Spot', ['A1', 'Laikago', 'Spot'], 'Robot Type.')
...
ROBOT_CLASS_MAP = {'A1': a1.A1, 'Laikago': laikago.Laikago, 'Spot': spot.Spot}
